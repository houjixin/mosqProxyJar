...
public class ConnectionInfo {
    ...
    public static ConnectionInfo fromJSONString(String conInfoStr){
    	if(StringUtils.isBlank(conInfoStr))
    		return null;
    	...
    	try{
    		...
    		if(joCon != null) {
    			...
    			conInfo.outHost = joCon.getString(DefaultValues.CON_INFO_OUT_HOST);
    			conInfo.outPort = joCon.getIntValue(DefaultValues.CON_INFO_OUT_PORT);
    			conInfo.session = joCon.getString(DefaultValues.CON_INFO_SESSION);
    		}
    		return conInfo;
    	}catch(Exception ex){
    		return null;
